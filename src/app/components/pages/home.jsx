  ...
  _getHomePageHero() {
    ...
    return (
      <FullWidthSection style={styles.root}>
          <img style={styles.svgLogo} src="images/energon.svg" />
          <div style={styles.tagline}>
            <h1 style={styles.h1}>cybertron</h1>
            <h2 style={styles.h2}>
              Transforming <span style={styles.nowrap}>
              the future of</span> <span style={styles.nowrap}>
              Data</span>
            </h2>
            <RaisedButton
