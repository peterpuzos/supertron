...
let ContentCopy = require('material-ui/lib/svg-icons/content/content-copy');
let ContentFilter = require('material-ui/lib/svg-icons/content/filter-list');
let ContentLink = require('material-ui/lib/svg-icons/content/link');
let Delete = require('material-ui/lib/svg-icons/action/delete');
let Download = require('material-ui/lib/svg-icons/file/file-download');
let MapsPlace = require('material-ui/lib/svg-icons/maps/place');
let PersonAdd = require('material-ui/lib/svg-icons/social/person-add');
let RemoveRedEye = require('material-ui/lib/svg-icons/image/remove-red-eye');
